...
contract FavorTreasury is ContractGuard, Ownable, ReentrancyGuard {
    ...
    function allocateSeigniorage() external onlyOneBlock nonReentrant checkCondition checkEpoch {
        _updateFavorPrice();
